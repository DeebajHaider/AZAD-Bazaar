...
export async function createOrder(orderData) {
  ...
  await invalidateCache(ORDERS_LIST);
  await invalidateCache(CART); // Creating an order usually clears the cart
